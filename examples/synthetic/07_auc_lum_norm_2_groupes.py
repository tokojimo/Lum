...
"""
Génère deux figures séparées pour l'AUC de luminescence normalisée.
...
METRIC = "AUC_Lum_norm"
Y_LABEL = "AUC of normalized luminescence"
USE_LOG_Y = False
FILE_PREFIX = "figure_AUC_Lum_norm"
POINTS_FILENAME = "figure_data_AUC_Lum_norm_points.csv"
PARAMS_FILENAME = "figure_data_parametres_par_serie_auc.csv"
REPORT_FILENAME = "resume_auc_lum_norm_2_groupes.txt"
ANALYSIS_LABEL = "AUC DE LUMINESCENCE NORMALISÉE"
TITLE_PREFIX = (
    "AUC of normalized luminescence of polyamine-associated promoter–lux "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Générer deux figures de l'AUC de luminescence normalisée, "
    ...
    parser.add_argument(
        "--log-y",
        action="store_true",
        help="Utiliser un axe Y logarithmique pour l'AUC (axe linéaire par défaut).",
    )
...
def main() -> None:
    ...
    generated = run_analysis(plotted, output_dir, use_log_y=(USE_LOG_Y or args.log_y))
